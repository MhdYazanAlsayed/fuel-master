import ForgetPassword from 'components/theme/authentication/simple/ForgetPassword';
import Registration from 'components/theme/authentication/simple/Registration';
import LoginForm from 'components/theme/authentication/LoginForm';
import ExperienceForm from 'components/theme/pages/user/settings/ExperienceForm';
import CreatePost from 'components/theme/app/social/feed/CreatePost';
import Compose from 'components/theme/app/email/compose/Compose';
import EventUpload from 'components/theme/app/events/create-an-event/EventUpload';
import React, { useState } from 'react';
import { Card, Col, Row } from 'react-bootstrap';
import WidgetSectionTitle from './WidgetSectionTitle';
import Flex from 'components/theme/common/Flex';
import { Link } from 'react-router-dom';
import PasswordReset from 'components/theme/authentication/simple/PasswordReset';
import PersonalForm from 'components/theme/wizard/PersonalForm';
