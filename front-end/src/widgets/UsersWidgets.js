...
import Events from 'components/theme/pages/user/profile/Events';
import Notification from 'components/theme/notification/Notification';
import FeedCard from 'components/theme/app/social/feed/FeedCard';
import rawFeeds from 'data/feed';
import FalconCardFooterLink from 'components/theme/common/FalconCardFooterLink';
import ProfileBanner from 'components/theme/pages/user/profile/Banner';
import EventBanner from 'components/theme/app/events/create-an-event/EventBanner';
...
import Followers from 'components/theme/pages/user/profile/Followers';
import ActivityLog from 'components/theme/pages/user/profile/ActivityLog';
import activities from 'data/activities';
import AddToFeed from 'components/theme/app/social/feed/AddToFeed';
import ActiveUsers from 'components/theme/dashboards/default/ActiveUsers';
