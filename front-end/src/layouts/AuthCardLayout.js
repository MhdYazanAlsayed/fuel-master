...
import Background from 'components/theme/common/Background';
...
const AuthCardLayout = ({ children }) => {
  ...
  const _authService = DependenciesInjector.services.authenticatorService;
                ...
                <Col md={5} className="text-white text-center bg-card-gradient">
                  <div className="position-relative p-4 pt-md-5 pb-md-7">
                    ...
                    <div className="z-index-1 position-relative light">
                      <div className="link-light mb-4 font-sans-serif fw-bolder fs-4 d-inline-block">
                        <Logo width={50} textClass={'text-white'} />
                      </div>
                      <p className="opacity-75 text-white">
                        {_languageService.resources.loginText}
                      </p>
                    </div>
                  </div>
